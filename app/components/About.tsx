export default function About() {
  return (
    <section id="about" className="py-24 px-6 md:px-20 bg-[#0d1526] overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-16 items-center">
          ...
          <div className="w-full md:w-1/2 relative group">
            <div className="relative z-10 bg-[#0f172a] p-6 rounded-3xl shadow-2xl border border-slate-800 transform -rotate-1 group-hover:rotate-0 transition-all duration-500">
              ...
              <div className="font-mono text-sm space-y-2">
                <p className="text-indigo-400">class <span className="text-yellow-300">WebApplication</span> &#123;</p>
                <p className="text-slate-400 pl-4">// Crafting scalable solutions</p>
                <p className="text-violet-400 pl-4">public function <span className="text-indigo-300">buildImpact</span>() &#123;</p>
            ...
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-gradient-to-br from-indigo-600 to-violet-600 rounded-2xl -z-10 shadow-xl flex flex-col items-center justify-center text-white transition-transform group-hover:scale-110 duration-500">
          ...
          <div className="w-full md:w-1/2 space-y-6">
            <h2 className="text-indigo-400 font-bold tracking-widest uppercase text-sm">About Me</h2>
            <h3 className="text-4xl font-extrabold text-white leading-tight">
              Transforming Ideas into{" "}
              <span className="bg-gradient-to-r from-indigo-400 to-violet-400 bg-clip-text text-transparent">Scalable</span>{" "}
              and{" "}
              <span className="bg-gradient-to-r from-indigo-400 to-violet-400 bg-clip-text text-transparent">Maintainable</span>{" "}
              Systems.
            </h3>

            <p className="text-lg text-slate-400 leading-relaxed">
              I am a Full-Stack Web Developer focused on building web applications with a structured and efficient approach. 
              I am highly accustomed to designing <span className="font-semibold text-slate-200">relational databases</span>, 
              developing robust <span className="font-semibold text-slate-200">RESTful APIs</span>, and ensuring seamless data flow between the backend and frontend.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
              <div className="space-y-2 bg-slate-900/50 border border-slate-800 rounded-2xl p-5 hover:border-indigo-500/40 transition-colors duration-300">
              ...
              <div className="space-y-2 bg-slate-900/50 border border-slate-800 rounded-2xl p-5 hover:border-indigo-500/40 transition-colors duration-300">
                <div className="flex items-center gap-2 text-indigo-400">
                  ...
                  <h4 className="font-bold text-white">Modern Frontend</h4>
                </div>
                <p className="text-sm text-slate-500">
