        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-16 items-center">
            ...
            <div className="w-full md:w-1/2 relative">
              <div className="relative z-10 bg-[#0f172a] p-6 rounded-3xl shadow-2xl border border-slate-800 transform -rotate-1 hover:rotate-0 transition-all duration-500 group">
            ...
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                Saya adalah Fullstack Web Developer yang berfokus pada pembangunan aplikasi berbasis web dengan pendekatan yang terstruktur dan efisien. 
                Saya terbiasa merancang <span className="font-semibold text-slate-800">database relasional</span>, 
                mengembangkan <span className="font-semibold text-slate-800">RESTful API</span>, serta memastikan alur data berjalan dengan baik antara backend dan frontend.
              </p>
  
              <p className="text-lg text-slate-600 leading-relaxed font-medium">
                Dengan menggunakan Laravel untuk backend dan React untuk frontend, saya membangun aplikasi yang tidak hanya berjalan dengan baik, 
                tetapi juga scalable, maintainable, dan mudah digunakan oleh pengguna akhir.
              </p>
